 ...
 * @LastEditTime: 2021-02-13 22:22:08
-->
...
预处理器cpp**将所有的#include头文件以及宏定义替换成其真正的内容**.例如预处理器会读C库中stdio.h的内容并插入到main.c中生成一个新文件main.i;
...
汇编器将main.s中的汇编语言翻译成计算机可以识别的机器语言存为main.o二进制文件.
